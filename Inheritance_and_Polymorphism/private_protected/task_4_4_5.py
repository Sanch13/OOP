...
#         self.__path = path  # начальный каталог с файлами
#         self.__exts = exts  # кортеж из отображаемых расширений файлов
# Вам необходимо объявить класс с именем FileDialogFactory (фабрика классов), который бы
# при выполнении команды:
# dlg = FileDialogFactory(title, path, exts)
# возвращал объект класса WindowsFileDialog, если CURRENT_OS равна строке 'windows',
# в противном случае - объект класса LinuxFileDialog. Объект самого класса FileDialogFactory
# создаваться не должен.
...
CURRENT_OS = 'windows1'  # 'windows', 'linux'
...
dlg = FileDialogFactory('Изображения', 'd:/images/', ('jpg', 'gif', 'bmp', 'png'))
print(dlg.__dict__)
print(isinstance(dlg, FileDialogFactory))
print(isinstance(dlg, WindowsFileDialog))
