# Подвиг 5. Вам поручено организовать представление объектов для продажи в риэлтерских
# агентствах. Для этого в программе нужно объявить базовый класс SellItem, объекты которого
# создаются командой:
# item = SellItem(name, price)
# где name - название объекта продажи (строка); price - цена продажи
# (число: целое или вещественное).
# Каждые конкретные типы объектов описываются следующими классами, унаследованные
# от базового SellItem:
# House - дома;
# Flat - квартиры;
...
# add_object(obj) - добавление нового объекта недвижимости для продажи (один из объектов
# классов: House, Flat, Land);
