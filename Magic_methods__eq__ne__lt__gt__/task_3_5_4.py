# Подвиг 7 (на повторение). Перед вами стоит задача выделения файлов с определенными расширениями
...
# acceptor(filename)
# и возвращать True, если файл с именем filename содержит расширения, указанные при создании
# acceptor, и False - в противном случае. Кроме того, с объектами класса FileAcceptor должен
...
class FileAcceptor:
    ...
    def __call__(self, file_extension, *args, **kwargs):
        return file_extension.split(".")[-1] in self.extensions

    def __add__(self, other):
        return self.__class__(*(self.extensions | other.extensions))


acceptor = FileAcceptor("jpg", "png", "txt")
